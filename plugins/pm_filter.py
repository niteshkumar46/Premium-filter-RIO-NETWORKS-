...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn = [
            [
                InlineKeyboardButton(
                    text="{file.file_name}", callback_data=f'files#{file.file_id}'
                ),
                InlineKeyboardButton(
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💥 Mᴏᴠɪᴇ Uᴘᴅᴀᴛᴇs 💥', url='https://t.me/bhagal_1410'),
            InlineKeyboardButton('😍 Movie group 🔍', url='https://t.me/+u9Nt77_9iRtiNTM1')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('🤖 Uᴩᴅᴀᴛᴇs 😜', url='https://t.me/bhagal_1410'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('😊 Source code 😊', url='https://t.me/nkp_pro')
        ], [
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('😪 Hᴏᴡ Tᴏ Oᴩᴇɴ Mʏ Lɪɴᴋs 💢', url='https://t.me/nkp_pro')
        ], [
            InlineKeyboardButton('📞 Cᴏɴᴛᴀᴄᴛ 📟', callback_data='contact')
        ], [
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='about')
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📞 Cᴏɴᴛᴀᴄᴛ Owner 📟', url='https://t.me/Himanshu_7357')
        ], [  
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='about')
        ], [
        ]]
